...
USE [master]
GO
CREATE DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF]
 CONTAINMENT = NONE
 ON  PRIMARY 
...
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET COMPATIBILITY_LEVEL = 130
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET ARITHABORT OFF 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET AUTO_CLOSE ON 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET AUTO_SHRINK ON 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET  DISABLE_BROKER 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET  MULTI_USER 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET DB_CHAINING OFF 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET QUERY_STORE = OFF
GO
USE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF]
GO
...
AS
SELECT        dbo.tCastAndCrew.LastName, dbo.tCastAndCrew.FirstName, dbo.tCastAndCrew.MiddleName, dbo.tCastAndCrew.BirthYear, dbo.tDVD.DVDId, dbo.tDVD.Title, dbo.tDVD.DistTrait, dbo.tCollectionType.Type AS CollectionType, 
                         dbo.tDVDxCrew.CreditedAs, dbo.tDVDxCrew.Episode, dbo.tDVDxCrew.[Group], dbo.tCreditType.Type AS CreditType, dbo.tCreditSubtype.Subtype AS CreditSubtype, dbo.tDVDxCrew.CustomRole
FROM            dbo.tDVD INNER JOIN
                         dbo.tCollectionType ON dbo.tDVD.CollectionTypeId = dbo.tCollectionType.CollectionTypeId INNER JOIN
...
AS
SELECT        dbo.tDVD.DVDId, dbo.tDVD.Title, dbo.tDVD.DistTrait, dbo.tCollectionType.Type AS CollectionType, dbo.tCastAndCrew.LastName, dbo.tCastAndCrew.FirstName, dbo.tCastAndCrew.MiddleName, dbo.tCastAndCrew.BirthYear, 
                         dbo.tDVDxCast.Episode, dbo.tDVDxCast.[Group], dbo.tDVDxCast.Role, dbo.tDVDxCast.CreditedAs, dbo.tDVDxCast.Voice, dbo.tDVDxCast.Uncredited, dbo.tDVDxCast.Puppeteer
FROM            dbo.tDVD INNER JOIN
                         dbo.tCollectionType ON dbo.tDVD.CollectionTypeId = dbo.tCollectionType.CollectionTypeId INNER JOIN
...
USE [master]
GO
ALTER DATABASE [D:\GIT\DVDPROFILERTOSQL\DVDPROFILERTOSQL\SQLDATABASE\COLLECTION.MDF] SET  READ_WRITE 
GO
